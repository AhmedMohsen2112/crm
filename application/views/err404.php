...
<html>
    ...
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="<?= base_url('assets/front/plugins/css') ?>/robot_page.css">
        <link rel="stylesheet" type="text/css" href="<?= base_url('assets/front/plugins/css') ?>/robot_styles.css">
        <script src="<?= base_url('assets/front/plugins/js') ?>/TweenMax.min.js"/></script>
    <script type="text/javascript" src="<?= base_url('assets/front/plugins/js') ?>/brokebot.js"/></script>
<script src="<?= base_url('assets/front/plugins/js') ?>/snap.svg-min.js" type="text/javascript"></script>
...
<body>
    ...
    <div>
        ...
        <div class="robotpage-bottom-half">
            ...
            <div>
                <p id="robot-text"><?= _lang('page_not_found') ?></p>
                <p><?= _lang('you_can_log_in_to_our_homepage_or_contact_us') ?></p>
                <div class="robot-buttons">
                    <a class="robot-buttons" href="<?= site_url() ?>"><?= _lang('home') ?></a>
                    <a class="robot-buttons" href="<?= site_url('contact_us') ?>"><?= _lang('contact_us') ?></a>
                </div>
            </div>
